rule compute_genetic_interaction_scores:
    ...
    log:
        "../outputs/logs/{screen}_{score}_compute_genetic_interaction_scores.log"
    params:
...
rule calculate_gene_level_scores:
    ...
    log:
        "../outputs/logs/{screen}_{score}_calculate_gene_level_scores.log"
    params:
        score=lambda wildcards: wildcards.score,
...
rule calculate_differential_scores:
    ...
    log:
        "../outputs/logs/{screen}_{rep}_calculate_differential_scores.log"
    params:
