...
gis2$nu.color[gis2$nu == 1 & gis2$InteractionScore < 0] <- "#33716B30"


coloring <- structure(gene.info$color, names = gene.info$gene)


pdf("figure_3b_negativenu_gamma_cluster.pdf", width = 8, height = 8)
...
pdf("figure_3b_negativenu_tau_cluster.pdf", width = 8, height = 8)
chordDiagram(gis2[,c(1,2,6)], 
             group = grouping, 
             grid.col = coloring, 
             small.gap = 0, 
...
pdf("figure_3b_negativenu_nu_cluster.pdf", width = 8, height = 8)
chordDiagram(gis2[,c(1,2,6)], 
             group = grouping, 
             grid.col = coloring, 
             small.gap = 0, 
